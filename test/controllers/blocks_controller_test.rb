...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { name: @block.name, treshold1: @block.treshold1, treshold2: @block.treshold2 }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { name: @block.name, treshold1: @block.treshold1, treshold2: @block.treshold2 }
    assert_redirected_to block_path(assigns(:block))
  end
